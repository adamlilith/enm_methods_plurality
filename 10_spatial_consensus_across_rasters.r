...
# 			values <- labels <- fill <- character()
# 			uniques <- unique(this_xy$pos_neg)
# 			if (any(uniques == 'Negative')) {
# 				values <- c(values, 'Negative' = '#7b3294')
# 				labels <- c(labels, 'Negative' = 'Neg')
# 				fill <- c(fill, 'Negative' = '#7b3294')
# 			}
# 			if (any(uniques == 'Positive')) {
# 				values <- c(values, 'Positive' = '#008837')
# 				labels <- c(labels, 'Positive' = 'Pos')
# 				fill <- c(fill, 'Positive' = '#008837')
# 			}
# 			if (any(uniques == 'Random')) {
# 				values <- c(values, 'Random' = 'yellow')
# 				labels <- c(labels, 'Random' = 'Random')
# 				fill <- c(fill, 'Random' = 'yellow')
# 			}
