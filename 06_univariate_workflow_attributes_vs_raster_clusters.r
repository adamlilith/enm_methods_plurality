...
# say('###############################################################################')
# say('### make PCA biplots with rasters coded by workflow attribute (no clusters) ###')
# say('###############################################################################')
...
# 	mantel_tests <- fread(paste0(this_out_dir, '/Univariate Mantel Test on Distance between Rasters and Workflows.csv'))
...
# 	### basic biplot with raster names color-coded by time period
# 	#############################################################
	
# 		biplot <- base_biplot +
# 			geom_shadowtext(
# 				data = scores, aes(x = PC1, y = PC2, label = raster, color = period), 
# 				size = 7,
# 				bg.colour = alpha('black', 0.2), bg.r = 0.05,
# 				fontface = 'bold'
# 			) +
...
# 		ggsave(biplot, filename = paste0(this_out_dir, '/Biplot - !Base.png'), width = 8, height = 5, dpi = 600, bg = 'white')

# 	### teams
# 	#########

# 		mantel_p <- mantel_tests$pvalue[mantel_tests$nice == 'Team']
...
# 		color_p <- if (mantel_p <= 0.05) { 'red' } else { 'gray40 '}

# 		biplot <- base_biplot +
# 			geom_polygon(data = polys, aes(x = PC1, y = PC2, fill = team), alpha = 0.4) +
# 			geom_shadowtext(
# 				data = scores, aes(x = PC1, y = PC2, label = team, color = team), 
# 				size = 5,
# 				bg.colour = alpha('black', 0.2), bg.r = 0.05,
# 				fontface = 'bold'
# 			) +
# 			annotate(
# 				'text', x = -Inf, y = Inf, label = paste0('Mantel~italic(P) == ~', sprintf('%.5f', mantel_p)), 
# 				parse = TRUE, hjust = -0.3, vjust = 1.5, size = 5, color = color_p, fontface = 'bold'
# 			) +
# 			ggtitle('Team') +
# 			coord_fixed() +
# 			theme_minimal() +
...
# 		mantel_p <- mantel_tests$pvalue[mantel_tests$nice == 'Projection: Time period']
...
# 		biplot <- base_biplot +
# 			geom_polygon(data = polys, aes(x = PC1, y = PC2, fill = period), alpha = 0.4) +
# 			geom_point(data = scores, aes(x = PC1, y = PC2, fill = period), pch = 21, alpha = 0.7, size = 5) +
# 			annotate(
# 				'text', x = -Inf, y = Inf, label = paste0('Mantel~italic(P) == ', sprintf('%.5f', mantel_p)), 
# 				parse = TRUE, hjust = -0.3, vjust = 1.5, size = 5, color = color_p, fontface = 'bold'
# 			) +
...
# 		mantel_p <- mantel_tests$pvalue[mantel_tests$nice == 'Predictions: Continuous/thresholded']
...
# 		biplot <- base_biplot +
# 			geom_polygon(data = polys, aes(x = PC1, y = PC2, fill = cluster), alpha = 0.4) +
...
# 			) +
# 			labs(fill = 'Output') +
# 			ggtitle('Continuous vs. Thresholding') +
# 			coord_fixed() +
# 			theme_minimal() +
# 			theme(
# 				legend.position = c(0.05, 0.05),
...
# 		mantel_p <- mantel_tests$pvalue[mantel_tests$nice == 'Predictors: Climate data source']
...
# 			) +
# 			labs(fill = 'Source') +
# 			ggtitle('Climate coverages source') +
# 			coord_fixed() +
# 			theme_minimal() +
# 			theme(
# 				legend.position = c(0.05, 0.05),
...
# 		mantel_p <- mantel_tests$pvalue[mantel_tests$nice == 'Predictors: Total number']
...
# 		mantel_p <- mantel_tests$pvalue[mantel_tests$nice == 'Occurrences: Number of occurrences']
...
# 		mantel_p <- mantel_tests$pvalue[mantel_tests$nice == 'Spatial resolution (km2)']
...
# 				parse = TRUE, hjust = -0.3, vjust = 1.5, size = 5, color = color_p, fontface = 'bold'
# 			) +
# 			labs(fill = 'Resolution (km²)') +
# 			ggtitle('Spatial Resolution') +
# 			coord_fixed() +
# 			theme_minimal() +
# 			theme(
# 				legend.position = c(0.05, 0.05),
...
# 		mantel_p <- mantel_tests$pvalue[mantel_tests$nice == 'Evaluation: Value of AUC']
...
# 			mantel_p <- mantel_tests$pvalue[mantel_tests$nice == 'Modeled only mainland subspecies']
...
# 					parse = TRUE, hjust = -0.3, vjust = 1.5, size = 5, color = color_p, fontface = 'bold'
# 				) +
# 				labs(fill = 'Focal population') +
# 				ggtitle('Taxonomic/geographic delineation') +
# 				coord_fixed() +
# 				theme_minimal() +
# 				theme(
# 					legend.position = c(0.05, 0.05),
...
# 		mantel_p <- mantel_tests$pvalue[mantel_tests$nice == 'Algorithm']
...
# 		mantel_p <- mantel_tests$pvalue[mantel_tests$nice == 'Non-presence type']
...
# 		mantel_p <- mantel_tests$pvalue[mantel_tests$nice == 'Software']
...
# 		biplot <- base_biplot +
# 			geom_polygon(data = polys, aes(x = PC1, y = PC2, fill = cluster), alpha = 0.5, color = 'gray') +
...
# 				parse = TRUE, hjust = -0.3, vjust = 1.5, size = 5, color = color_p, fontface = 'bold'
# 			) +
# 			labs(fill = 'Software', shape = 'Software') +
# 			ggtitle('Software') +
# 			coord_fixed() +
# 			theme_minimal() +
# 			theme(
...
# 		mantel_p <- mantel_tests$pvalue[mantel_tests$nice == 'SDM standards: Mean rank']
